...
function PayableLpgOrdersPage() {
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <div>
        <h1 className="text-xl md:text-2xl font-semibold text-foreground tracking-tight text-balance">Payable LPG Orders</h1>
        <p className="text-muted-foreground">
          Approved LPG orders where the customer's wallet balance covers the total.

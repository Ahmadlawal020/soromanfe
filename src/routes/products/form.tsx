...
function ProductForm() {
  ...
  const validate = () => {
    ...
    if (!formData.gradeClass.trim()) newErrors.gradeClass = 'Quality Grade is required'
    return newErrors
  }
      ...
      <header className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            {isEdit ? 'Modify details of this petroleum listing' : 'Fill in the details to add a new product'}
          </p>
        </div>
      </header>
          ...
          <div className="space-y-4 border rounded-lg p-4">
            ...
            <div className="space-y-3">
              ...
              <div>
                ...
                />
                {errors.gradeClass && (
                  <p className="text-sm text-destructive mt-1">{errors.gradeClass}</p>
                )}
              </div>

  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <div className="flex justify-between items-center">
        <div><h1 className="text-xl md:text-2xl font-semibold text-foreground tracking-tight text-balance">Petroleum Products</h1><p className="text-muted-foreground">Manage petroleum product listings, grades, and distribution categories.</p></div>

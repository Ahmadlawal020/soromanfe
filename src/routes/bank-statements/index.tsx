...
function BankStatementsPage() {
  ...
  return (
    <div className="animate-fade-in space-y-6">
      <div>
        <p className={cn(MICRO, 'mb-1.5 text-muted-foreground')}>Finance</p>
        <h1 className="text-xl font-semibold tracking-tight text-balance md:text-2xl">
          Bank statements
        </h1>
        <p className="mt-1 text-sm text-muted-foreground">
          Upload statements so Finance can match deposits instead of retyping them.
        </p>
      </div>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                className="h-8 w-full rounded-lg border border-input bg-transparent px-2.5 text-sm outline-none file:mr-3 file:h-6 file:rounded-md file:border-0 file:bg-muted file:px-2 file:text-xs file:font-medium disabled:pointer-events-none disabled:opacity-50 dark:bg-input/30"
              />
            </div>
          </div>
          ...
          {grid && !mapping && (
            <div className="space-y-4 rounded-lg border border-warning/40 bg-warning/5 p-4">
              <div className="flex items-start gap-2">
                ...
                <div>
                  <p className="text-sm font-medium">Set up this account's format</p>

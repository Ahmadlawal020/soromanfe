...
import { Package, Clock, CheckCircle, DollarSign, Search, Plus, X, Eye, FileText, MapPin, Truck, Hourglass, XCircle } from 'lucide-react'
...
function DangoteOrdersDashboard() {
  ...
  // Filter by status, payment and collection status
